package com.example.testewirelesss;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        write_msg_box = findViewById(R.id.writeMsg);

        btnOnOff.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                wifiManager.setWifiEnabled(!wifiManager.isWifiEnabled());
                btnOnOff.setText("Wifi " + wifiManager.isWifiEnabled());
            }
        });
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                msg = write_msg_box.getText().toString();
    ...
    public class ClientClass extends Thread{
        ...
        public ClientClass(InetAddress hostAddres) {
            hostAdd = hostAddres.getHostAddress();
            socket = new Socket();
        }
